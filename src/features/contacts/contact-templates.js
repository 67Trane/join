...
function detailTemplate(name, email, phone, id, first, last, color, user) {
    ...
    return `                
        ...
        <div class="exit-detail" id="exit-detail" onclick="closeDetailDialog()">
            <img src="/join/assets/img/exit-detail.svg">
        </div>   
                ...
                <div class="name-wrapper">
                    ...
                    <div class="edit-button-desk-wrapper">
                        <div class="edit-row-desk" onclick="openEditContactDialog('${id}', '${name}', '${email}', ${user})">
                            <img src="/join/assets/img/edit-small.svg">
                            <p>Edit</p>
                        </div>
                        <div class="edit-row-desk" onclick="deleteContact('${id}'), deleteAssigned('${name}')">
                            <img src="/join/assets/img/delete-small.svg">
                            <p>Delete</p>
                        </div>
                    </div>
                </div>
...
function addDialogTemplate() {
    ...
    <div class="contact-card add">
        <div class="exit-wrapper">
            <img class="exit" src="/join/assets/img/contact-card/close.svg" alt="Close" onclick="closeAddContactDialog()">
        </div>
        <div class="card-header">
            <img src="/join/assets/img/contact-card/join-logo-card.svg">
            <h2>Add Contact</h2>
            <h3>Tasks are better with a team!</h3>
            <div class="separator-card"></div>
        </div>
        <div class="card-image-outter">
            <div class="card-image"><img src="/join/assets/img/contact-card/avatar.svg"></div>
        </div>
        <form class="card-body form" id="contactForm">
            <div class="input-wrapper">
                <div class="input-container">
                    <input type="text" required placeholder="Name" id="name" name="name">
                    <img class="icon" src="/join/assets/img/contact-card/person.svg">
                    <div class="error-message" id="name-error"></div>
                </div>
                <div class="input-container">
                    <input type="text" required placeholder="Email" id="email" name="email">
                    <img class="icon" src="/join/assets/img/contact-card/mail.svg">
                    <div class="error-message" id="email-error"></div>
                </div>
                <div class="input-container">
                    <input type="text" required placeholder="Phone" id="phone" name="phone">
                    <img class="icon" src="/join/assets/img/contact-card/call.svg">
            ...
            <div class="btn-wrapper">
                <button class="btn cancel" onclick="closeAddContactDialog(event)">
                    Cancel
                    <img src="/join/assets/img/contact-card/exit.svg">
                </button>
                <button class="btn create" onclick="getInputValues(event)">
                    Create Contact
                    <img src="/join/assets/img/contact-card/check.svg">
                </button>
            </div>
        </form>
    </div>`;
...
function showEditOverlay(name, email, user, color) {
    ...
    <div class="contact-card add">
        <div class="exit-wrapper">
            <img class="exit" src="/join/assets/img/contact-card/close.svg" onclick="closeEditContactDialog()">
        </div>
        <div class="card-header">
            <img src="/join/assets/img/contact-card/join-logo-card.svg">
            <h2>Edit Contact</h2>
